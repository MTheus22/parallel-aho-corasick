...
> **Next idea to implement: idea 4 (parallel BFS construction).**
...
| 4  | Parallel BFS construction of fail/goto/dict_suffix| Build          | [`idea_4.md`](idea_4.md) | 2nd   | Not implemented                     |
